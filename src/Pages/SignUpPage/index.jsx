                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    className={`block w-full rounded-md px-3 py-2 border-2 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6 ${formik.errors.name ? 'border-red-500' : ''}`}
                                />
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        className={`block w-full rounded-md px-3 py-2 border-2 text-gray-900 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6 ${formik.errors.confirmPassword ? 'border-red-500' : ''}`}
                                    />
                        ...
                        <div className="mt-4">
                            <label className="flex items-center">
                                <input
                                    ...
                                    className="form-checkbox accent-green-500 h-4 w-4 text-green-600 focus:ring-green-500 border-white rounded"
                                />
